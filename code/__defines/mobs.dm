...
#define DO_TIMER_MULT        0.3 // Multiplier for timer adjustments
#define DO_TIMER_STEP(X)     (X * DO_TIMER_MULT)

#define DO_TIMER_MIN         1 SECOND // Minimum timer time, enforced when modified. Also for actions that should be really fast but not right-as-you-click
#define DO_TIMER_QUICK       3 SECONDS
#define DO_TIMER_SHORT       6 SECONDS
#define DO_TIMER_MEDIUM      9 SECONDS
#define DO_TIMER_LONG        12 SECONDS
#define DO_TIMER_EXTREME     15 SECONDS

#define DO_TIMER_ESCAPE      2 MINUTES

#define DO_TIMER_TOOL_SIMPLE DO_TIMER_QUICK
#define DO_TIMER_TOOL_MEDIUM DO_TIMER_MEDIUM

#define DO_TIMER_FLAG_SILENT            0x1 // Don't output any messages to user
#define DO_TIMER_FLAG_USER_SIZE_SMALL   0x2 // Adjusts timer based on size. Smaller is faster.
#define DO_TIMER_FLAG_USER_SIZE_LARGE   0x4 // Adjusts timer based on size. Larger is faster.
#define DO_TIMER_FLAG_USER_SKILL        0x8 // Adjusts timer based on user skill. Higher is faster.

#define DO_TIMER_FLAG_TOOL              (DO_TIMER_FLAG_USER_SKILL) // Common timer flags for tool usage

// used in /mob/living/carbon/human/can_inject, and by various callers of that proc
#define CAN_INJECT 1
#define INJECTION_PORT 2
#define INJECTION_PORT_DELAY DO_TIMER_QUICK // used by injectors to apply delay due to searching for a port on the injectee's suit
